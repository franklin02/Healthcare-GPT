...
def get_spl_set_id(results, openfda):
    ...
    if set_id: return set_id
    if spl_set_id: return spl_set_id
    return 'N/A'
...
def get_notable_inactive_ingredients(results, openfda):
    ...
    if inactive_ingredients == 'N/A': return 'N/A'
...
def collect_data(set_id: str, api_key: str) -> DrugSnapshot:
    ...
    snapshot.notable_inactive_ingredients = get_notable_inactive_ingredients(results, openfda)
